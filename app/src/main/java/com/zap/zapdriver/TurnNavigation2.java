...
public class TurnNavigation2 extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener, PermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turn_navigation2);
...
//
    ...
    private Location getLastKnownLocation() {
        ...
        if (ActivityCompat.checkSelfPermission(TurnNavigation2.this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(TurnNavigation2.this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
...
//
//        Point dest = Point.fromLngLat(app.getDestination().latitude, app.getDestination().longitude);
//
//
